...
def edit_pdf(input_path: str | Path, output_path: str | Path, *, page: int = 1,
    ...
    with pymupdf.open(source) as document:
        ...
        selected_width = box.widths.with_explicit(width).require_available_width()
        ...
        report = {
            ...
            "observed_content_width": box.observed_content_width,
            "inferred_available_width": box.inferred_available_width,
            "explicitly_supplied_width": width,
